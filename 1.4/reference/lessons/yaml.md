---
description: "Lesson: YAML frontmatter — allowed keys, version in description. version: 1.4"
---
...
Version goes inside `description`, wrapped in double quotes:
    ---
    description: "Lesson: memory and agents. version: 1.4"
    ---
...
single quotes for inner quotes:
    ---
    description: "Сеть и DNS — диагностика «нет интернета». version: 1.4"
    ---
